...
const init = function () {
	...
	div.innerHTML = '<div class="goog-toolbar-separator goog-toolbar-separator-disabled goog-inline-block"></div>' +
									...
									'<div id="rfgs_id_block" class="goog-inline-block goog-flat-button" style="display: none; text-align: center; line-height: 16px;">' +
										'<div>Slide ID:</div>' +
										'<div id="rfgs_id_container" style="font-size: 16px; font-weight: 600;">' +
											'******' +
										'</div>' +
									'</div>' +
									'<div class="goog-inline-block goog-flat-button" style="text-align: center; font-size: 11px; line-height: 16px;">' +
										'get slidecontrol:' +
										'<br>' +
										'<a id="rfgs_app_url" style="font-size: 14px; color: #e3e3e3; text-decoration: none; font-weight: 500;" href="https://slides.limhenry.xyz" target="_blank">' +
											'slidecontrol.com' +
										'</a>' +
									'</div>' +
