...
// 0.36.0
// Generated at Wed Nov  7 15:32:24 CST 2018
  ...
  return (function (r) {
    ...
    function (t, N, e) {
      ...
      (function (t) {
        ...
        function f(t, e) {
          if ((u(e), (t = a(t, e < 0 ? 0 : 0 | h(e))), !c.TYPED_ARRAY_SUPPORT))
          ...
          (c.prototype.write = function (t, e, r, n) {
            ...
            for (var o, s, a, u, f, l, c, h, p, d = !1; ; )
              switch (n) {
                ...
                case "utf-8":
                  return (
                    (h = e), (p = r), I(L(t, (c = this).length - h), c, h, p)
                  );
                case "ascii":
                  return m(this, t, e, r);
                case "latin1":
                case "binary":
                  return m(this, t, e, r);
                case "base64":
                  return (u = this), (f = e), (l = r), I(C(t), u, f, l);
                case "ucs2":
                case "ucs-2":
                case "utf16le":
                case "utf-16le":
        ...
        function C(t) {
          return n.toByteArray(
            (function (t) {
              ...
              if (
                (t = ((e = t),
                e.trim ? e.trim() : e.replace(/^\s+|\s+$/g, "")).replace(B, ""))
                  .length < 2
              )
                return "";
              for (; t.length % 4 != 0; ) t += "=";
    ...
    function (t, e, r) {
      ...
      r(1)(n, l),
        ...
        ((n.Stream = n).prototype.pipe = function (e, t) {
          ...
          function u(t) {
            if ((f(), 0 === l.listenerCount(this, "error"))) throw t;
          }
          function f() {
    ...
    function (t, e) {
      ...
      function h() {
        l &&
          u &&
          ((l = !1), u.length ? (f = u.concat(f)) : (c = -1), f.length && p());
      }
      function p() {
        if (!l) {
          var t = a(h);
      ...
      (i.nextTick = function (t) {
        ...
        f.push(new d(t, e)), 1 !== f.length || l || a(p);
      }),
    ...
    function (ek, fk) {
      ...
      try {
        gk = gk || Function("return this")() || eval("this");
      } catch (t) {
        "object" == typeof window && (gk = window);
      }
      ek.exports = gk;
    },
    function (t, O, h) {
      (function (n, i) {
        ...
        (O.format = function (t) {
          ...
          (O.deprecate = function (t, e) {
            if (_(n.process))
              return function () {
                return O.deprecate(t, e).apply(this, arguments);
              };
            ...
            return function () {
              if (!r) {
                ...
                i.traceDeprecation ? console.trace(e) : console.error(e),
                  (r = !0);
              }
        ...
        function u(t, e) {
          ...
          return (
            ...
            b(e) ? (r.showHidden = e) : e && O._extend(r, e),
        ...
        (O.debuglog = function (e) {
          if (
            (_(t) && (t = i.env.NODE_DEBUG || ""), (e = e.toUpperCase()), !o[e])
          )
          ...
          (O.isBoolean = b),
          (O.isNull = m),
          (O.isNullOrUndefined = function (t) {
            return null == t;
          }),
          (O.isNumber = v),
          (O.isString = w),
          (O.isSymbol = function (t) {
    ...
    function (t, e, r) {
      ((((e = t.exports = r(26)).Stream = e).Readable = e).Writable = r(14)),
        (e.Duplex = r(6)),
        (e.Transform = r(30)),
        (e.PassThrough = r(49));
    },
          ...
          return (
            ...
            new Promise(function (t, e) {
              ...
              n.on("data", function (t) {
                ...
                .on("end", function () {
                  t(i.isBuffer(r[0]) ? i.concat(r).toString() : r);
                })
                .on("error", e);
            })
          );
          ...
          function (t, e) {
            ...
            return (
              ...
              this._events.newListener &&
                this.emit("newListener", t, u(e.listener) ? e.listener : e),
              this._events[t]
                ? f(this._events[t])
    ...
    function (S, t, T) {
      ...
      (function (t, e, r) {
        ...
        var n = T(8);
        n.inherits = T(1);
        var i = { deprecate: T(48) },
          o = T(27),
          m = T(11).Buffer,
          v = r.Uint8Array || function () {};
        var s,
          u = T(28);
        function w() {}
        function f(t, e) {
        ...
        function l(t) {
          if (((a = a || T(6)), !(s.call(l, this) || this instanceof a)))
            return new l(t);
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var u = r.chunk,
                ...
                l = r.callback;
              if (
                (_(t, e, !1, e.objectMode ? 1 : u.length, u, f, l),
                (r = r.next),
            ...
            i &&
              ...
              (n = e).prefinished ||
                ...
                ("function" == typeof r._final
                  ? (n.pendingcb++, (n.finalCalled = !0), b.nextTick(g, r, n))
        ...
        n.inherits(l, o),
            ...
            ? ((s = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(l, Symbol.hasInstance, {
                value: function (t) {
                  return (
                    !!s.call(this, t) ||
                    (this === l && t && t._writableState instanceof f)
                  );
                },
              }))
            : (s = function (t) {
          ...
          (l.prototype.write = function (t, e, r) {
            var n,
              ...
              y = !1,
              g = !d.objectMode && ((n = t), m.isBuffer(n) || n instanceof v);
            return (
              g && !m.isBuffer(t) && ((i = t), (t = m.from(i))),
              "function" == typeof e && ((r = e), (e = null)),
              g ? (e = "buffer") : e || (e = d.defaultEncoding),
              ...
              d.ended
                ...
                : (g ||
                    ...
                    l && (o.emit("error", l), b.nextTick(u, l), (f = !1)),
                    f)) &&
                  (d.pendingcb++,
            ...
            "function" == typeof t
              ...
              n.ending ||
                ...
                (function (t, e, r) {
                  (e.ending = !0),
                    E(t, e),
                    r && (e.finished ? b.nextTick(r) : t.once("finish", r));
      ...
      }).call(t, T(3), T(46).setImmediate, T(4));
    },
    function (t, e, r) {
      (function (i) {
        var o = Object.prototype.toString,
          s =
            "function" == typeof i.alloc &&
            "function" == typeof i.allocUnsafe &&
        ...
        t.exports = function (t, e, r) {
          ...
          return (
            (n = t),
            "ArrayBuffer" === o.call(n).slice(8, -1)
              ? (function (t, e, r) {
                  e >>>= 0;
                  ...
                  if (void 0 === r) r = n;
                    ...
                    throw new RangeError("'length' is out of bounds");
                  return s
                    ? i.from(t.slice(e, e + r))
                    : new i(new Uint8Array(t.slice(e, e + r)));
                })(t, e, r)
              : "string" == typeof t
                ? (function (t, e) {
                    if (
    ...
    function (n, t, i) {
      ...
      (function (e) {
        ...
        u.inherits(d, t),
          (d.WEBSOCKET_CONNECTION_ERROR = "WebSocket connection error"),
          (d.prototype.initialize = function () {
            var r = this.options;
            r.token && !r["watson-token"] && (r["watson-token"] = r.token),
              r.content_type &&
                !r["content-type"] &&
                (r["content-type"] = r.content_type),
              r["X-WDC-PL-OPT-OUT"] &&
                !r["X-Watson-Learning-Opt-Out"] &&
                (r["X-Watson-Learning-Opt-Out"] = r["X-WDC-PL-OPT-OUT"]);
            var t = u._extend(
                "customization_id" in r
                  ? f(r, p)
              ...
              n =
                (
                  r.url || "wss://stream.watsonplatform.net/speech-to-text/api"
                ).replace(/^http/, "ws") +
                "/v1/recognize?" +
                e,
              i = f(r, h);
            i.action = "start";
            var o = this,
              s = (this.socket = new l(n, null, null, r.headers, null));
            function a(t, e, r) {
              r ? (r.message = t + " " + r.message) : (r = new Error(t)),
                (r.raw = e),
                o.emit("error", r);
            }
            o.on("finish", o.finish.bind(o)),
              (s.onerror = function (t) {
                o.listening = !1;
                var e = new Error("WebSocket connection error");
                (e.name = d.WEBSOCKET_CONNECTION_ERROR),
                  (e.event = t),
                  o.emit("error", e),
                  o.push(null);
              }),
              (this.socket.onopen = function () {
                o.sendJSON(i), o.emit("open");
              }),
              ...
              (s.onmessage = function (e) {
                if ("string" != typeof e.data)
                  return a("Unexpected binary data received from server", e);
                var t;
                try {
                  t = JSON.parse(e.data);
                } catch (t) {
                  return a("Invalid JSON received from service:", e, t);
                }
                o.emit("message", e, t),
                  t.error
                    ? a(t.error, e)
                      ...
                      : r.readableObjectMode
                        ...
                        : Array.isArray(t.results) &&
                          t.results.forEach(function (t) {
                            t.final &&
                              t.alternatives &&
                              o.push(t.alternatives[0].transcript, "utf8");
                          });
              }),
              (this.initialized = !0);
          }),
          (d.prototype.sendJSON = function (t) {
            return (
              this.emit("send-json", t), this.socket.send(JSON.stringify(t))
            );
          }),
          (d.prototype.sendData = function (t) {
            return this.emit("send-data", t), this.socket.send(t);
          }),
          (d.prototype._read = function () {}),
          (d.ERROR_UNRECOGNIZED_FORMAT = "UNRECOGNIZED_FORMAT"),
          (d.prototype._write = function (t, e, r) {
            var n = this;
            if (!n.finished)
              if (this.initialized) n.sendData(t), this.afterSend(r);
              else {
                if (!this.options["content-type"]) {
                  var i = d.getContentType(t);
                  if (!i) {
                    var o = new Error(
                      "Unable to determine content-type from file header, please specify manually.",
                    );
                    return (
                      (o.name = d.ERROR_UNRECOGNIZED_FORMAT),
                      this.emit("error", o),
                      void this.push(null)
                    );
                  }
                ...
                this.initialize(),
                  this.once("open", function () {
                    n.sendData(t), n.afterSend(r);
                  });
              }
          }),
          (d.prototype.afterSend = function (t) {
            this.socket.bufferedAmount <=
            (this._writableState.highWaterMark || 0)
              ? e.nextTick(t)
              : setTimeout(this.afterSend.bind(this, t), 10);
          }),
          ...
          (d.prototype.finish = function () {
            if (!this.finished) {
              ...
              var t = this,
                e = { action: "stop" };
              t.socket && t.socket.readyState === t.socket.OPEN
                ? t.sendJSON(e)
                : this.once("open", function () {
                    t.sendJSON(e);
                  });
          ...
          (d.prototype.promise = i(9)),
          (d.getContentType = function (t) {
            return r.fromHeader(t);
          }),
          (n.exports = d);
      }).call(t, i(3));
    },
    function (t, e, r) {
      ...
      e.fromHeader = function (t) {
        var e = t.slice(0, 4).toString().substr(0, 4);
        return i[e] || i[e.substr(0, 3)];
      };
      var o = {
        ".mp3": "audio/mp3",
        ".wav": "audio/wav",
      ...
      e.fromFilename = function (t) {
        var e = n(("string" == typeof t && t) || t.name || "");
        return o[e];
      };
    },
    function (t, e, r) {
      ...
      var n = r(2).Transform,
        ...
        s = r(12);
      function a(t) {
        (this.options = s(t, { model: "", hesitation: "", decodeStrings: !1 })),
      ...
      (a.prototype.clean = function (t) {
        return (
          (t = t
            ...
            .replace(f, "")
            .replace(l, "")),
          this.isJaCn && (t = t.replace(/ /g, "")),
          t.trim() + " "
        );
      }),
        (a.prototype.capitalize = function (t) {
        ...
        (a.prototype.transformString = function (t, e, r) {
          this.push(this.formatString(t.toString())), r();
        }),
        (a.prototype.transformObject = function (t, e, r) {
          this.push(this.formatResult(t)), r();
        }),
        (a.prototype.formatString = function (t, e) {
          return (t = this.capitalize(this.clean(t))), e ? t : this.period(t);
        }),
        (a.prototype.formatResult = function (r) {
          return (
            (r = o(r)),
            Array.isArray(r.results) &&
              r.results.forEach(function (t, e) {
                var n = t.final || e !== r.results.length - 1;
                t.alternatives = t.alternatives.map(function (t) {
                  return (
                    (t.transcript = this.formatString(t.transcript, !n)),
                    t.timestamps &&
                      (t.timestamps = t.timestamps
                        .map(function (t, e, r) {
                          return (
                            (t[0] = this.clean(t[0])),
                            0 === e && (t[0] = this.capitalize(t[0])),
                            e === r.length - 1 &&
                              n &&
                              (t[0] = this.period(t[0])),
                            t
            ...
            return (
              ...
              (function i(t, o) {
                ...
                if (v(t, w)) s = new w();
                  ...
                  (s = new RegExp(t.source, T(t))),
                    t.lastIndex && (s.lastIndex = t.lastIndex);
                else if (S.__isDate(t)) s = new Date(t.getTime());
                else {
                  if (m && A.isBuffer(t))
                    return (
                      (s = A.allocUnsafe
                        ? A.allocUnsafe(t.length)
                        : new A(t.length)),
                      t.copy(s),
                      s
                    );
                  v(t, Error)
                    ? (s = Object.create(t))
                    : void 0 === d
                      ? ((e = Object.getPrototypeOf(t)), (s = Object.create(e)))
                      : ((s = Object.create(d)), (e = d));
                }
                if (p) {
                  var r = g.indexOf(t);
                  if (-1 != r) return b[r];
                ...
                t)) {
                  var a;
                  e && (a = Object.getOwnPropertyDescriptor(e, n)),
                    (a && null == a.set) || (s[n] = i(t[n], o - 1));
                }
                if (Object.getOwnPropertySymbols) {
                  ...
                  for (n = 0; n < u.length; n++) {
                    ...
                    (!(c = Object.getOwnPropertyDescriptor(t, f)) ||
                      ...
                      ((s[f] = i(t[f], o - 1)),
                      c.enumerable ||
                        Object.defineProperty(s, f, { enumerable: !1 }));
                  }
                }
                if (y) {
                  ...
                  for (n = 0; n < l.length; n++) {
                    ...
                    ((c = Object.getOwnPropertyDescriptor(t, h)) &&
                      c.enumerable) ||
                      ((s[h] = i(t[h], o - 1)),
                      Object.defineProperty(s, h, { enumerable: !1 }));
                  }
                }
                return s;
              })(t, e)
    ...
    function (t, e, r) {
      ...
      function s(t) {
        if (
          ((this.options = t =
            o(t, { decodeStrings: !1, property: null, clear: !0 })),
          (this.el =
            "string" == typeof t.outputElement
              ? document.querySelector(t.outputElement)
              : t.outputElement),
          !this.el)
        )
          throw new Error(
      ...
      i.inherits(s, n),
        (s.prototype.writeString = function (t, e, r) {
          (this.el[this.prop] += t), r();
        }),
        (s.prototype.writeObject = function (t, e, r) {
          Array.isArray(t.results) &&
            t.results.forEach(function (t) {
              t.final
                ? ((this.finalizedText += t.alternatives[0].transcript),
    ...
    function (t, e, r) {
      ...
      var n = r(2).Transform,
        ...
        o = r(19);
      function s(t) {
        ((t = t || {}).objectMode = !0), n.call(this, t);
      }
      i.inherits(s, n),
        (s.prototype._transform = function (r, t, e) {
          Array.isArray(r.results)
            ? r.results.forEach(function (t) {
                var e = o(t);
                (e.index = r.result_index), this.push(e);
              }, this)
            : this.push(r),
            e();
        }),
        (s.prototype.promise = r(9)),
        (t.exports = s);
    },
    function (t, e, r) {
      "use strict";
      ...
      (a.ERROR_MISMATCH = "MISMATCH"),
        (a.prototype.buildMessage = function () {
          var l = this.isFinal();
          this.extraLabels = !1;
          var i = 0,
            o = -1,
            t = this.speaker_labels.map(function (t) {
              var e = this.results[i];
              o++;
              var r = e.alternatives[0].timestamps[o];
              if (
                (r ||
                  ((o = 0),
                  i++,
                  (r =
                    (e = this.results[i]) && e.alternatives[0].timestamps[o])),
                !r)
              )
                return (this.extraLabels = !0), null;
              if (r[1] === t.from && r[2] === t.to)
                return { timestamp: r, speaker: t.speaker, result: e };
              if (!this.mismatchErrorEmitted) {
                var n = new Error(
                  "Mismatch between speaker_label and word timestamp",
                );
                (n.name = a.ERROR_MISMATCH),
                  (n.speaker_label = t),
                  (n.timestamp = r),
                  (n.speaker_labels = this.speaker_labels),
                  (n.results = this.results),
                  this.emit("error", n),
          ...
          if (!this.extraLabels) {
            var c = (t = t.filter(function (t) {
              return t;
            })).reduce(function (t, e) {
              var r = t[t.length - 1];
              return (
                r && r.speaker === e.speaker && r.result === e.result
                  ? r.timestamps.push(e.timestamp)
                  : ((r = {
                      speaker: e.speaker,
            ...
            return {
              results: c.map(function (t, e) {
                var r,
                  n = c[e - 1] || {};
                (r =
                  t.result === n.result
                    ? { alternatives: [{}] }
                    : h(t.result)).speaker = t.speaker;
                var i = r.alternatives[0];
                (i.transcript =
                  t.timestamps
                    .map(function (t) {
                      return t[0];
                    ...
                    .join(" ") + " "),
                  (i.timestamps = t.timestamps),
                  (r.final = l);
                var o = t.timestamps[0][1],
                  s = t.timestamps[t.timestamps.length - 1][2];
                if (t.result.word_alternatives) {
                  var a = t.result.word_alternatives.filter(function (t) {
                    return t.start_time >= o && t.end_time <= s;
                  });
                  r.word_alternatives = a;
                }
                var u = t.result.keywords_result;
                if (u) {
                  var f = {};
                  Object.keys(u).forEach(function (t) {
                    var e = u[t].filter(function (t) {
                      return t.start_time >= o && t.end_time <= s;
                    });
                    e.length && (f[t] = e);
                  }),
        ...
        (a.prototype.handleResults = function (t) {
          if (s(t)) {
            var e = new Error(
              "SpeakerStream requires that timestamps and speaker_labels be enabled",
            );
            return (e.name = s.ERROR_NO_TIMESTAMPS), void this.emit("error", e);
          }
          t.results
            .filter(function (t) {
              return t.final;
        ...
        (a.speakerLabelsSorter = function (t, e) {
        ...
        (a.prototype.handleSpeakerLabels = function (t) {
          var e = t.speaker_labels;
          o(this.speaker_labels, e, function (t, e) {
            ...
            this.speaker_labels.sort(a.speakerLabelsSorter);
        }),
        (a.prototype._transform = function (t, e, r) {
          ...
          Array.isArray(t.results) &&
            ...
            this.options.speakerlessInterim &&
              t.results.length &&
              !1 === t.results[0].final &&
              ((n = this.buildMessage()).results = n.results.concat(t.results)),
            this.extraLabels &&
              t.results.length &&
              !0 === t.results[0].final &&
              (n = this.buildMessage())),
            Array.isArray(t.speaker_labels) &&
              (this.handleSpeakerLabels(t), (n = this.buildMessage())),
            n && this.push(n),
            r();
        }),
        (a.prototype._flush = function (t) {
          var e = this.results
            .map(function (t) {
              return t.alternatives[0].timestamps;
            })
            .reduce(function (t, e) {
              return t.concat(e);
            }, []);
          if (e.length !== this.speaker_labels.length) {
            var r;
            r =
              e.length && !this.speaker_labels.length
    ...
    function (u, f, t) {
      ...
      !(function (t) {
        ...
        var i = "undefined" != typeof Promise,
        ...
        function a(r) {
          return i
            ? o
              ...
              : new Promise(function (t, e) {
                  if (!s) return e(new n());
                  s.call(navigator, r, t, e);
                })
            : new e();
        }
        (a.NotSupportedError = n),
          (a.isSupported = !(!i || (!o && !s))),
          void 0 ===
            (l = function () {
              return a;
      ...
      (function (l) {
        ...
        function e(e) {
          if ("undefined" != typeof MediaStream && e instanceof MediaStream) {
            var t = e;
            (e = arguments[1] || {}).stream = t;
          }
          e = e || {};
          var r = void 0 === window.AudioContext ? 4096 : null;
          r = e.bufferSize || r;
          c.call(this, e);
          var n = this,
            i = !0;
          function o(t) {
            i &&
              n.push(
                e.objectMode
                  ? t.inputBuffer
                  : h(t.inputBuffer.getChannelData(0).buffer),
              );
          }
          var s,
            a = window.AudioContext || window.webkitAudioContext,
            u = (this.context = e.context || new a()),
            f = u.createScriptProcessor(r, 1, 1);
          f.connect(u.destination),
            (this.setStream = function (t) {
              (this.stream = t),
                (s = u.createMediaStreamSource(t)).connect(f),
                (f.onaudioprocess = o);
            }),
            e.stream && this.setStream(t),
            (this.stop = function () {
              if ("closed" !== u.state) {
                try {
                  this.stream.getTracks()[0].stop();
                } catch (t) {}
                f.disconnect(), s && s.disconnect();
                try {
                  u.close();
                } catch (t) {}
                (i = !1), n.push(null), n.emit("close");
              }
            }),
            l.nextTick(function () {
              n.emit("format", {
      ...
      (function (t, g) {
        ...
        function o(t, e) {
          ...
          (this.highWaterMark = n || 0 === n ? n : r && (i || 0 === i) ? i : o),
            ...
            (this.encoding = null),
            t.encoding &&
              (a || (a = U(29).StringDecoder),
              (this.decoder = new a(t.encoding)),
              (this.encoding = t.encoding));
        }
        function h(t) {
          if (((s = s || U(6)), !(this instanceof h))) return new h(t);
        ...
        function E(t) {
          ...
          (e.needReadable = !1),
            e.emittedReadable ||
              ...
              (e.emittedReadable = !0),
              e.sync ? b.nextTick(S, t) : S(t));
        }
        function S(t) {
          w("emit readable"), t.emit("readable"), x(t);
        }
        function T(t, e) {
          e.readingMore || ((e.readingMore = !0), b.nextTick(A, t, e));
        }
        function A(t, e) {
          for (
            var r = e.length;
            ...
            (w("maybeReadMore read 0"), t.read(0), r !== e.length);
        ...
        function j(t) {
          ...
          e.endEmitted || ((e.ended = !0), b.nextTick(P, e, t));
        }
        function P(t, e) {
          t.endEmitted ||
            0 !== t.length ||
        ...
        (h.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? j(this) : E(this),
              null
            );
          ...
          (h.prototype.pipe = function (r, t) {
            ...
            var e =
              (!t || !1 !== t.end) && r !== g.stdout && r !== g.stderr ? s : y;
            function o(t, e) {
              w("onunpipe"),
                t === n &&
                  e &&
            ...
            i.endEmitted ? b.nextTick(e) : n.once("end", e), r.on("unpipe", o);
            var a,
              u =
                ((a = n),
                function () {
            ...
            function h(t) {
              w("onerror", t),
                y(),
                r.removeListener("error", h),
                0 === v(r, "error") && r.emit("error", t);
            }
            function p() {
              r.removeListener("finish", d), y();
            }
            function d() {
              w("onfinish"), r.removeListener("close", p), y();
            }
            function y() {
              w("unpipe"), n.unpipe(r);
            }
            return (
              ...
              r.once("finish", d),
              r.emit("pipe", n),
              i.flowing || (w("pipe resume"), n.resume()),
              r
            );
          }),
            ...
            function (t, e) {
              ...
              if ("data" === t)
                ...
                n.endEmitted ||
                  ...
                  (n.emittedReadable = !1),
                  n.reading ? n.length && E(this) : b.nextTick(k, this));
              }
              return r;
            }),
          (h.prototype.resume = function () {
            ...
            return (
              r.flowing ||
                ...
                (t = this),
                (e = r).resumeScheduled ||
                  ((e.resumeScheduled = !0), b.nextTick(O, t, e))),
              this
            );
          }),
    ...
    function (t, e, r) {
      ...
      var s = r(55);
      t.exports = function (t, e) {
        if (!s(t) && "function" != typeof t) return {};
        var r = {};
        if ("string" == typeof e) return e in t && (r[e] = t[e]), r;
    ...
    function (s, t, a) {
      ...
      (function (e) {
        var r = a(2).Transform,
          ...
          i = a(15);
        function o(t) {
          (t = this.options = n(t, { sourceSampleRate: 48e3, downsample: !0 })),
            r.call(this, t),
            (this.bufferUnusedSamples = []),
            t.objectMode || t.writableObjectMode
              ? (this._transform = this.handleFirstAudioBuffer)
              : ((this._transform = this.transformBuffer),
                e.nextTick(this.emitFormat.bind(this)));
        }
        t.inherits(o, r),
          (o.prototype.emitFormat = function () {
            this.emit("format", {
              channels: 1,
              bitDepth: 16,
          ...
          (o.prototype.downsample = function (t) {
            var e,
              r,
              n = null,
              i = t.length,
            ...
            if (0 < o) {
              for (n = new Float32Array(o + i), e = 0; e < o; ++e)
                n[e] = this.bufferUnusedSamples[e];
              for (e = 0; e < i; ++e) n[o + e] = t[e];
            } else n = t;
            var s = [
              ...
              a = this.options.sourceSampleRate / 16e3,
              u = Math.floor((n.length - s.length) / a) + 1,
              f = new Float32Array(u);
            for (e = 0; e + s.length - 1 < n.length; e++) {
              r = Math.round(a * e);
              for (var l = 0, c = 0; c < s.length; ++c) l += n[r + c] * s[c];
              f[e] = l;
            }
            var h = Math.round(a * e),
              p = n.length - h;
            if (0 < p)
              for (
                this.bufferUnusedSamples = new Float32Array(p), e = 0;
                e < p;
                ++e
              )
                this.bufferUnusedSamples[e] = n[h + e];
            else this.bufferUnusedSamples = new Float32Array(0);
            return f;
          }),
          (o.prototype.floatTo16BitPCM = function (t) {
            for (
              var e = new DataView(new ArrayBuffer(2 * t.length)), r = 0;
              r < t.length;
              r++
            ) {
              var n = t[r] < 0 ? 32768 : 32767;
              e.setInt16(2 * r, (t[r] * n) | 0, !0);
            }
            return i(e.buffer);
          }),
          (o.prototype.handleFirstAudioBuffer = function (t, e, r) {
            (this.options.sourceSampleRate = t.sampleRate),
              this.emitFormat(),
              (this._transform = this.transformAudioBuffer),
              this._transform(t, e, r);
          }),
          (o.prototype.transformAudioBuffer = function (t, e, r) {
            var n = t.getChannelData(0);
            this.options.downsample && (n = this.downsample(n)),
              this.push(this.floatTo16BitPCM(n)),
              r();
          }),
          (o.prototype.transformBuffer = function (t, e, r) {
            var n = new Float32Array(t.buffer);
            this.options.downsample && (n = this.downsample(n)),
              this.push(this.floatTo16BitPCM(n)),
              r();
          }),
    ...
    function (t, e, r) {
      ...
      (t.exports = function (t) {
        return t.results.some(function (t) {
          var e = t.alternatives && t.alternatives[0];
          return !(
            !e ||
            ((!e.transcript.trim() || e.timestamps) && e.timestamps.length)
          );
        });
      }),
        (t.exports.ERROR_NO_TIMESTAMPS = "NO_TIMESTAMPS");
    },
    function (t, e, r) {
      "use strict";
      var o = r(17),
      ...
      function a(t, e) {
        ...
        if (!r.canPlayType(e)) {
          var n = new Error("Current browser is unable to play back " + e);
          throw ((n.name = a.ERROR_UNSUPPORTED_FORMAT), (n.contentType = e), n);
        }
        (r.src = URL.createObjectURL(new Blob([t], { type: e }))),
          r.play(),
          (this.stop = function () {
      ...
      function i(e) {
        return new Promise(function (r, n) {
          var t = new Blob([e]).slice(0, 4),
            i = new FileReader();
          i.readAsText(t),
            (i.onload = function () {
              var t = o.fromHeader(s(i.result));
              if (t) r(t);
              else {
                var e = new Error(
                  "Unable to determine content type from file header. Supported file types: wav, mp3, flac, ogg, and webm.",
                );
                (e.name = a.ERROR_UNSUPPORTED_FORMAT), n(e);
              }
            });
        });
      }
      (a.ERROR_UNSUPPORTED_FORMAT = "UNSUPPORTED_FORMAT"),
        (t.exports = a),
        (t.exports.getContentType = i),
        (t.exports.playFile = function (e, t) {
          return "string" == typeof e
            ? Promise.resolve(new n(e))
            : t
              ? Promise.resolve(new a(e, t))
              : i(e).then(function (t) {
                  return new a(e, t);
                });
        });
      ...
      (function (a) {
        ...
        t.inherits(n, e),
          ...
          (n.prototype._transform = function (t, e, r) {
            ...
            if (Array.isArray(t.results) && t.results.length && u(t)) {
              var n = new Error("TimingStream requires timestamps");
              return (n.name = u.ERROR_NO_TIMESTAMPS), r(n);
            }
            if (!this.stopped) {
              var i = this.getDelayMs(t),
                o = this.options.objectMode || this.options.readableObjectMode,
                s = Array.isArray(t.results && t.results.length);
              if (
                (!o && s && (t = t.results[0].alternatives[0].transcript),
                !o && !s)
              )
                return r();
          ...
          (n.prototype.getMessageTime = function (t) {
            if (this.options.emitAt === n.START) {
              if (Array.isArray(t.results) && t.results.length)
                return t.results[t.results.length - 1].alternatives[0]
                  .timestamps[0][n.START];
              if (Array.isArray(t.speaker_labels) && t.speaker_labels.length)
                return t.speaker_labels[0].from;
            } else {
              if (Array.isArray(t.results) && t.results.length) {
                var e =
                  t.results[t.results.length - 1].alternatives[0].timestamps;
                return e[e.length - 1][n.END];
              }
              if (Array.isArray(t.speaker_labels) && t.speaker_labels.length)
                return t.speaker_labels[t.speaker_labels.length - 1].to;
            }
            return 0;
          }),
          (n.prototype.getDelayMs = function (t) {
            var e = this.getMessageTime(t),
              r = this.startTime + 1e3 * e - Date.now();
            return Math.max(0, r);
          }),
          (n.prototype.setStartTime = function (t) {
            this.startTime = t || Date.now();
          }),
          (n.prototype.promise = o(9)),
          (n.prototype.stop = function () {
            (this.stopped = !0), clearTimeout(this.timeout), this.emit("stop");
          }),
          (i.exports = n);
      }).call(t, o(0).Buffer);
    },
    ...
    function (e, t, r) {
      ...
      (function (t) {
        e.exports = {
          recognizeMicrophone: r(42),
          recognizeFile: r(68),
          getModels: r(81),
          WebAudioL16Stream: r(33),
          RecognizeStream: r(16),
          FilePlayer: r(36),
          FormatStream: r(18),
          TimingStream: r(37),
          ResultStream: r(21),
          SpeakerStream: r(22),
          WritableElementStream: r(20),
          getUserMedia: r(24),
          MicrophoneStream: r(25),
          Buffer: t,
        };
      }).call(t, r(0).Buffer);
    },
            ...
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((s = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  2 <= (e += 1 <= s + c ? h / u : h * Math.pow(2, 1 - c)) * u &&
                    (s++, (u /= 2)),
                  l <= s + c
                    ? ((a = 0), (s = l))
                    : 1 <= s + c
    ...
    function (t, e, r) {
      ...
      (t.exports = function (t) {
        ...
        t.outputElement && !1 !== t.objectMode && (t.objectMode = !0),
          t.extractResults && (t.objectMode = !0),
          t.resultsBySpeaker && ((t.objectMode = !0), (t.speaker_labels = !0)),
          (t.format = !1 !== t.format),
        ...
        s && f
          ? (f.unpipe(v), (e = f))
          : ((e = new c({ objectMode: !0, bufferSize: t.bufferSize })),
            (t.mediaStream
              ? Promise.resolve(t.mediaStream)
              : l({ video: !1, audio: !0 })
            )
              .then(function (t) {
                e.setStream(t), s && (f = e);
              ...
              .catch(function (t) {
                o.emit("error", t), "NotSupportedError" === t.name && o.end();
              }));
        var a = new p({ writableObjectMode: !0 });
        function u() {
          e.unpipe(a), e.pipe(v), a.end();
        }
        return (
          e.pipe(a).pipe(n),
          i.push(e, a),
          s
            ? (n.on("end", u), n.on("stop", u))
            : (n.on("end", e.stop.bind(e)), n.on("stop", e.stop.bind(e))),
          t.resultsBySpeaker && ((o = o.pipe(new m(t))), i.push(o)),
          t.format && ((o = o.pipe(new d(t))), i.push(o)),
          t.outputElement && i.push(o.pipe(new g(t))),
          t.extractResults && ((o = o.pipe(new b())), i.push(o)),
          i.forEach(function (t) {
            t !== o && t.on("error", o.emit.bind(o, "error"));
          }),
          o !== n && (o.stop = n.stop.bind(n)),
          (o.recognizeStream = n),
          o
        );
      }),
        (t.exports.isSupported = l.isSupported);
    },
    function (t, e) {},
    function (t, e, r) {
      "use strict";
                ...
                "[object process]" === {}.toString.call(r.process)
                  ...
                  : (function () {
                    ...
                    ? ((s = "setImmediate$" + Math.random() + "$"),
                      ...
                      r.addEventListener
                        ? r.addEventListener("message", t, !1)
    ...
    function (t, e, r) {
      t.exports = r(7).Transform;
    },
    function (t, e, r) {
      t.exports = r(7).PassThrough;
    },
    function (t, e) {
      t.exports = function (t) {
        return (
      ...
      t.exports = {
        _args: [
          [
            ...
            "/Users/dustinpopp/Desktop/sdk/dev/speech-javascript-sdk",
          ],
        ],
        _from: "websocket@>=1.0.26 <2.0.0",
        _hasShrinkwrap: !1,
        ...
        _npmUser: { name: "theturtle32", email: "theturtle32@gmail.com" },
        _npmVersion: "6.4.1",
        _phantomChildren: {},
        _requested: {
          raw: "websocket@^1.0.26",
        ...
        _resolved:
          "https://registry.npmjs.org/websocket/-/websocket-1.0.28.tgz",
        _shasum: "9e5f6fdc8a3fe01d4422647ef93abdd8d45a78d3",
        _shrinkwrap: null,
        _spec: "websocket@^1.0.26",
        _where: "/Users/dustinpopp/Desktop/sdk/dev/speech-javascript-sdk",
        author: {
          name: "Brian McKelvey",
    ...
    function (t, f, e) {
      (function (i) {
        ...
        (f.resolve = function () {
          ...
          (f.normalize = function (t) {
            var e = f.isAbsolute(t),
              r = "/" === n(t, -1);
            return (
              (t = o(
                a(t.split("/"), function (t) {
          ...
          (f.relative = function (t, e) {
            function r(t) {
              for (var e = 0; e < t.length && "" === t[e]; e++);
              for (var r = t.length - 1; 0 <= r && "" === t[r]; r--);
              return r < e ? [] : t.slice(e, r - e + 1);
            }
            (t = f.resolve(t).substr(1)), (e = f.resolve(e).substr(1));
            for (
              var n = r(t.split("/")),
                i = r(e.split("/")),
    ...
    function (e, t, r) {
      (function (y) {
        var t = (function () {
          ...
          function p(t, u, e, f) {
            "object" == typeof u &&
              ((e = u.depth), (f = u.prototype), u.filter, (u = u.circular));
            var l = [],
              c = [],
              h = void 0 !== y;
            return (
              ...
              (function t(e, r) {
                ...
                if (p.__isArray(e)) n = [];
                  ...
                  (n = new RegExp(e.source, d(e))),
                    e.lastIndex && (n.lastIndex = e.lastIndex);
                else if (p.__isDate(e)) n = new Date(e.getTime());
                else {
                  if (h && y.isBuffer(e))
                    return (
                      (n = y.allocUnsafe
                        ? y.allocUnsafe(e.length)
                        : new y(e.length)),
                      e.copy(n),
                      n
                    );
                  void 0 === f
                    ? ((i = Object.getPrototypeOf(e)), (n = Object.create(i)))
                    : ((n = Object.create(f)), (i = f));
                }
                if (u) {
                  var o = l.indexOf(e);
                  if (-1 != o) return c[o];
                ...
                for (var s in e) {
                  var a;
                  i && (a = Object.getOwnPropertyDescriptor(i, s)),
                    (a && null == a.set) || (n[s] = t(e[s], r - 1));
                }
                return n;
              })(t, e)
            );
          ...
          return (
            (p.clonePrototype = function (t) {
              if (null === t) return null;
              var e = function () {};
              return (e.prototype = t), new e();
            }),
            (p.__objToStr = e),
            (p.__isDate = function (t) {
              return "object" == typeof t && "[object Date]" === e(t);
            }),
            (p.__isArray = function (t) {
              return "object" == typeof t && "[object Array]" === e(t);
            }),
            (p.__isRegExp = function (t) {
              return "object" == typeof t && "[object RegExp]" === e(t);
            }),
            (p.__getRegExpFlags = d),
            p
          );
        })();
        "object" == typeof e && e.exports && (e.exports = t);
    ...
    function (t, e, r) {
      ...
      var c = r(62),
        ...
        h = r(66)(),
        p = Object,
        d = n.call(Function.call, Array.prototype.push),
        y = n.call(Function.call, Object.prototype.propertyIsEnumerable),
        g = h ? Object.getOwnPropertySymbols : null;
      t.exports = function (t, e) {
        ...
        for (r = 1; r < arguments.length; ++r) {
          (n = p(arguments[r])), (o = c(n));
          var l = h && (Object.getOwnPropertySymbols || g);
          if (l)
            for (s = l(n), i = 0; i < s.length; ++i)
              (u = s[i]), y(n, u) && d(o, u);
          for (i = 0; i < o.length; ++i)
            (a = n[(u = o[i])]), y(n, u) && (f[u] = a);
        }
        return f;
      };
    },
      ...
      var h = Object.prototype.hasOwnProperty,
        ...
        s = function (t) {
          var e = null !== t && "object" == typeof t,
            r = "[object Function]" === p.call(t),
            n = d(t),
            i = e && "[object String]" === p.call(t),
            o = [];
          if (!e && !r && !n)
            throw new TypeError("Object.keys called on a non-object");
          var s = g && r;
          if (i && 0 < t.length && !h.call(t, 0))
            for (var a = 0; a < t.length; ++a) o.push(String(a));
          if (n && 0 < t.length)
            for (var u = 0; u < t.length; ++u) o.push(String(u));
          else
            for (var f in t)
              (s && "prototype" === f) || !h.call(t, f) || o.push(String(f));
          if (y)
            for (
              var l = (function (t) {
                  if ("undefined" == typeof window || !v) return m(t);
                  try {
                    return m(t);
                  } catch (t) {
                    return !1;
              ...
              (l && "constructor" === b[c]) || !h.call(t, b[c]) || o.push(b[c]);
          return o;
        };
      (s.shim = function () {
        if (Object.keys) {
    ...
    function (t, e, r) {
      ...
      t.exports = function (e) {
        var r = this;
        if ("function" != typeof r || "[object Function]" !== f.call(r))
          throw new TypeError(
        ...
        for (
          var n,
            ...
            t = Math.max(0, r.length - i.length),
            o = [],
            s = 0;
          s < t;
          s++
        ...
        if (
          ((n = Function(
            ...
            if (this instanceof n) {
              var t = r.apply(this, i.concat(u.call(arguments)));
              return Object(t) === t ? t : this;
            }
            return r.apply(e, i.concat(u.call(arguments)));
          })),
          r.prototype)
        ) {
          var a = function () {};
    ...
    function (t, e) {
      ...
      function n(t, e, r, n) {
        ...
        for (
          ...
          for (
            var f = 0, l = e[s], c = r ? r(l) : l;
            -1 < (f = o(u, c, f, n));

          )
            u !== t && d.call(u, f, 1), d.call(t, f, 1);
        return t;
      }
      t.exports = function (t, e, r) {
        return t && t.length && e && e.length ? n(t, e, void 0, r) : t;
      };
    },
    function (t, e, r) {
      "use strict";
      ...
      t.exports = function (r) {
        ...
        r.data &&
          ...
          r.outputElement && !1 !== r.objectMode && (r.objectMode = !0),
          r.extractResults && (r.objectMode = !0),
          r.resultsBySpeaker && ((r.objectMode = !0), (r.speaker_labels = !0)),
          (r.format = !1 !== r.format),
          void 0 === r.smart_formatting && (r.smart_formatting = r.format);
        var t = r.realtime || (void 0 === r.realtime && r.play);
        t && (r.timestamps = !0),
          r["content-type"] || (r["content-type"] = m.fromFilename(r.file));
        var n,
          e = d({ interim_results: !0 }, r),
          i = new l(e),
          o = [i],
          s = i;
        if ("string" == typeof r.file)
          v(r.file)
            .then(function (t) {
              return t.readable();
            })
            .then(function (t) {
              t.pipe(i), o.unshift(t);
            })
            .catch(function (t) {
              i.emit("error", t);
            });
        ...
        if (
          (t
            ? ((n = new p(r)),
              (s = s.pipe(n)),
              o.push(s),
              s.on("stop", i.stop.bind(i)))
            : (s.stop = i.stop.bind(i)),
          r.resultsBySpeaker && ((s = s.pipe(new b(r))), o.push(s)),
          r.format && ((s = s.pipe(new h(r))), o.push(s)),
          r.play &&
            c
              .playFile(r.file, r["content-type"])
              .then(function (t) {
                if (
                  (i.on("stop", t.stop.bind(t)),
                  i.on("error", t.stop.bind(t)),
                  n && "string" == typeof r.file)
                ) {
                  var e = function () {
                    n.setStartTime(), t.audio.removeEventListener("playing", e);
                  };
                  t.audio.addEventListener("playing", e);
                }
              })
              .catch(function (t) {
                var e = o.filter(function (t) {
                  return (
                    ...
                    (t._readableState.pipes === s ||
                      (Array.isArray(t._readableState.pipes) &&
                        -1 !== t._readableState.pipes.indexOf(s)))
                  );
                });
                s.emit("error", t),
          ...
          r.outputElement && o.push(s.pipe(new y(r))),
          r.extractResults)
        ) {
          var u = s.stop ? s.stop.bind(s) : i.stop.bind(i);
          ((s = s.pipe(new g())).stop = u), o.push(s);
        }
        return (
          o.forEach(function (t) {
            t !== s && t.on("error", s.emit.bind(s, "error"));
          }),
          s.stop || (s.stop = n ? n.stop.bind(n) : i.stop.bind(i)),
          (s.recognizeStream = i),
          s
        );
      };
    ...
    function (i, t, o) {
      ...
      (function (t, s) {
        ...
        function n(t, e) {
          ...
          if ((((e = e || {}).objectMode = !1), r.call(this, e), !t))
          ...
          if (!a) throw Error("Your environment does not support FileReader");
          if (!u) throw Error("Your environment does not support Uint8Array");
        ...
        e((i.exports = n), r),
          (n.prototype.read = function () {
            var t = n.super_.prototype.read.apply(this, arguments);
            return (
              !s.isBuffer(t) ||
                t instanceof u ||
                (t = (function (t) {
                  if (
                    ((t = new u(t)),
                    "function" == typeof s._augment && (t = s._augment(t)),
                    !(t instanceof u))
                  )
          ...
          (n.prototype._read = function (t) {
            var e,
              ...
              n = this._blob.size;
            if (
              ((e = this._nextByteStart),
              (r = Math.min(e + t, n)),
              (this._nextByteStart = r),
              e >= this._blob.size)
            )
              this.push(null);
            else {
              var i = this._blob.slice(e, r),
                o = new a();
              (o.onload = function () {
                var t = new u(o.result);
                (t = (function (t) {
                  if ("function" == typeof s._augment) {
                    if (!((t = s._augment(t)) instanceof u))
                      throw Error(
    ...
    function (t, e, r) {
      r(72), (t.exports = self.fetch.bind(self));
    },
    function (t, e) {
      !(function (t) {
        "use strict";
            ...
            (this._initBody = function (t) {
              if ((this._bodyInit = t))
                if ("string" == typeof t) this._bodyText = t;
                  ...
                  if (!i || (!ArrayBuffer.prototype.isPrototypeOf(t) && !u(t)))
    ...
    function (t, e, r) {
      var n = r(74);
      t.exports = function (e) {
        return (e = e || {}).body && e.body.readable
          ? n(e.body).then(function (t) {
              return (e.body = t), e;
            })
          : Promise.resolve(e);
      };
    ...
    function (e, t, r) {
      (function (i) {
        var o = r(7).Writable,
          t = r(1),
          a = r(76);
        if ("undefined" == typeof Uint8Array) var u = r(77).Uint8Array;
        else u = Uint8Array;
        function s(t, e) {
          ...
          var r = t.encoding,
            n = !1;
          r
            ? ("u8" !== (r = String(r).toLowerCase()) && "uint8" !== r) ||
              (r = "uint8array")
            : (n = !0),
            o.call(this, { objectMode: !0 }),
            (this.encoding = r),
        ...
        t((e.exports = s), o),
          ...
          (s.prototype.inferEncoding = function (t) {
            var e = void 0 === t ? this.body[0] : t;
            return i.isBuffer(e)
              ? "buffer"
                      ...
                      : "uint8array" === this.encoding
                        ? (function (t) {
                            for (var e = 0, r = 0; r < t.length; r++)
                              "string" == typeof t[r] && (t[r] = a(t[r])),
                                (e += t[r].length);
                            for (
                              var n = new u(e), r = 0, i = 0;
                              r < t.length;
                              r++
                            )
        ...
        function f(t) {
          return (
            "string" == typeof t ||
            ((e = t), /Array\]$/.test(Object.prototype.toString.call(e))) ||
            (t && "function" == typeof t.subarray)
          );
          var e;
        }
      }).call(t, r(0).Buffer);
    ...
    function (t, h) {
          ...
          : function (t, e, r) {
              ...
              return (
                y.HasProperty(r, "get") &&
                  ...
                  Object.prototype.__defineGetter__.call(t, e, r.get),
                y.HasProperty(r, "set") &&
                  Object.prototype.__defineSetter__ &&
                  Object.prototype.__defineSetter__.call(t, e, r.set),
                y.HasProperty(r, "value") && (t[e] = r.value),
                t
              );
            };
      var i =
        ...
        function (t) {
          ...
          var e,
            r = [];
          for (e in t) y.HasOwnProperty(t, e) && r.push(e);
          return r;
        };
      function o(t, e) {
        var r = 32 - e;
      ...
      function O(t) {
        return [(t = n(Number(t))) < 0 ? 0 : 255 < t ? 255 : 255 & t];
      }
      function x(t) {
      ...
      function L(t) {
        return s((t[0] << 24) | (t[1] << 16) | (t[2] << 8) | t[3], 32);
      }
      function a(t, e, r) {
        var n,
          i,
        ...
        function c(t) {
          var e = m(t),
            r = t - e;
          return r < 0.5 ? e : 0.5 < r ? e + 1 : e % 2 ? e + 1 : e;
        }
        for (
          t != t
            ? ((i = (1 << e) - 1), (o = _(2, r - 1)), (n = 0))
            : t === 1 / 0 || t === -1 / 0
              ? ((i = (1 << e) - 1), (n = t < (o = 0) ? 1 : 0))
              : 0 === t
                ? (n = 1 / t == -1 / (o = i = 0) ? 1 : 0)
          ...
          a.push(o % 2 ? 1 : 0), (o = m(o / 2));
        for (s = e; s; s -= 1) a.push(i % 2 ? 1 : 0), (i = m(i / 2));
        for (a.push(n ? 1 : 0), a.reverse(), u = a.join(""), f = []; u.length; )
          f.push(parseInt(u.substring(0, 8), 2)), (u = u.substring(8));
        return f;
      }
      function u(t, e, r) {
        var n,
          ...
          l,
          c = [];
        for (n = t.length; n; n -= 1)
          for (o = t[n - 1], i = 8; i; i -= 1) c.push(o % 2 ? 1 : 0), (o >>= 1);
        return (
          c.reverse(),
          (s = c.join("")),
          (a = (1 << (e - 1)) - 1),
          (u = parseInt(s.substring(0, 1), 2) ? -1 : 1),
          (f = parseInt(s.substring(1, 1 + e), 2)),
          (l = parseInt(s.substring(1 + e), 2)),
          f === (1 << e) - 1
            ? 0 !== l
              ? NaN
              : u * (1 / 0)
      ...
      !(function () {
        ...
        function t(t, e, r) {
          ...
          return (
            ((a = function (t, e, r) {
              var n, i, o, s;
              if (arguments.length && "number" != typeof t)
                if ("object" == typeof t && t.constructor === a)
                  for (
                    n = t,
                      this.length = n.length,
                      this.byteLength = this.length * this.BYTES_PER_ELEMENT,
                      this.buffer = new u(this.byteLength),
                      o = this.byteOffset = 0;
                    o < this.length;
                    o += 1
                  )
                  ...
                  "object" != typeof t ||
                  t instanceof u ||
                  "ArrayBuffer" === y.Class(t)
                ) {
                  if (
                    "object" != typeof t ||
                    !(t instanceof u || "ArrayBuffer" === y.Class(t))
                  )
                    throw new TypeError("Unexpected argument type(s)");
                  if (
                    ((this.buffer = t),
                    (this.byteOffset = y.ToUint32(e)),
                  ...
                  for (
                    i = t,
                      this.length = y.ToUint32(i.length),
                      this.byteLength = this.length * this.BYTES_PER_ELEMENT,
                      this.buffer = new u(this.byteLength),
                      o = this.byteOffset = 0;
                    o < this.length;
                    ...
                    (s = i[o]), this._setter(o, Number(s));
              else {
                if (((this.length = y.ToInt32(t)), r < 0))
                  throw new RangeError(
            ...
            (a.prototype.BYTES_PER_ELEMENT = t),
            (a.prototype._pack = e),
            (a.prototype._unpack = r),
            (a.BYTES_PER_ELEMENT = t),
            (a.prototype._getter = function (t) {
              if (arguments.length < 1)
                throw new SyntaxError("Not enough arguments");
              if (!((t = y.ToUint32(t)) >= this.length)) {
                var e,
                  r,
                  n = [];
                for (
            ...
            (a.prototype.get = a.prototype._getter),
            (a.prototype._setter = function (t, e) {
            ...
            (a.prototype.set = function (t, e) {
              if (arguments.length < 1)
                throw new SyntaxError("Not enough arguments");
              var r, n, i, o, s, a, u, f, l, c;
              if ("object" == typeof t && t.constructor === this.constructor) {
                if (((r = t), (i = y.ToUint32(e)) + r.length > this.length))
                  throw new RangeError(
                    "Offset plus length of array is out of range",
                  );
                if (
                  ((f = this.byteOffset + i * this.BYTES_PER_ELEMENT),
                  (l = r.length * this.BYTES_PER_ELEMENT),
                  r.buffer === this.buffer)
                ) {
                  for (c = [], s = 0, a = r.byteOffset; s < l; s += 1, a += 1)
                    c[s] = r.buffer._bytes[a];
                  for (s = 0, u = f; s < l; s += 1, u += 1)
                    this.buffer._bytes[u] = c[s];
                } else
                  for (
                    s = 0, a = r.byteOffset, u = f;
                    s < l;
                    s += 1, a += 1, u += 1
                  )
                    this.buffer._bytes[u] = r.buffer._bytes[a];
              } else {
                ...
                if (
                  ...
                  (i = y.ToUint32(e)) + o > this.length)
                )
                  throw new RangeError(
                    "Offset plus length of array is out of range",
                  );
                for (s = 0; s < o; s += 1)
                  (a = n[s]), this._setter(i + s, Number(a));
              }
            }),
            (a.prototype.subarray = function (t, e) {
              function r(t, e, r) {
        ...
        var e = t(1, S, T),
          ...
          l = t(4, D, N),
          c = t(8, I, C);
        (h.Int8Array = h.Int8Array || e),
          (h.Uint8Array = h.Uint8Array || r),
          (h.Uint8ClampedArray = h.Uint8ClampedArray || i),
          (h.Int16Array = h.Int16Array || o),
          (h.Uint16Array = h.Uint16Array || s),
          (h.Int32Array = h.Int32Array || a),
          (h.Uint32Array = h.Uint32Array || f),
          (h.Float32Array = h.Float32Array || l),
          (h.Float64Array = h.Float64Array || c);
      })(),
        (function () {
          function u(t, e) {
            return y.IsCallable(t.get) ? t.get(e) : t[e];
          }
          var t,
            f =
              ((t = new h.Uint16Array([4660])),
              18 === u(new h.Uint8Array(t.buffer), 0)),
            e = function (t, e, r) {
              if (0 === arguments.length) t = new h.ArrayBuffer(0);
              else if (
                !(t instanceof h.ArrayBuffer || "ArrayBuffer" === y.Class(t))
              )
                throw new TypeError("TypeError");
              if (
                ((this.buffer = t || new h.ArrayBuffer(0)),
                (this.byteOffset = y.ToUint32(e)),
                this.byteOffset > this.buffer.byteLength)
              )
                throw new RangeError("byteOffset out of range");
          ...
          function r(o) {
            return function (t, e) {
              if ((t = y.ToUint32(t)) + o.BYTES_PER_ELEMENT > this.byteLength)
                throw new RangeError("Array index out of range");
              t += this.byteOffset;
              var r,
                n = new h.Uint8Array(this.buffer, t, o.BYTES_PER_ELEMENT),
                i = [];
              for (r = 0; r < o.BYTES_PER_ELEMENT; r += 1) i.push(u(n, r));
              return (
                Boolean(e) === Boolean(f) && i.reverse(),
                u(new o(new h.Uint8Array(i).buffer), 0)
              );
            };
          }
          function n(a) {
            return function (t, e, r) {
              if ((t = y.ToUint32(t)) + a.BYTES_PER_ELEMENT > this.byteLength)
                throw new RangeError("Array index out of range");
              var n,
                i = new a([e]),
                o = new h.Uint8Array(i.buffer),
                s = [];
              for (n = 0; n < a.BYTES_PER_ELEMENT; n += 1) s.push(u(o, n));
              Boolean(r) === Boolean(f) && s.reverse(),
                new h.Uint8Array(this.buffer, t, a.BYTES_PER_ELEMENT).set(s);
            };
          }
          (e.prototype.getUint8 = r(h.Uint8Array)),
            (e.prototype.getInt8 = r(h.Int8Array)),
            (e.prototype.getUint16 = r(h.Uint16Array)),
            (e.prototype.getInt16 = r(h.Int16Array)),
            (e.prototype.getUint32 = r(h.Uint32Array)),
            (e.prototype.getInt32 = r(h.Int32Array)),
            (e.prototype.getFloat32 = r(h.Float32Array)),
            (e.prototype.getFloat64 = r(h.Float64Array)),
            (e.prototype.setUint8 = n(h.Uint8Array)),
            (e.prototype.setInt8 = n(h.Int8Array)),
            (e.prototype.setUint16 = n(h.Uint16Array)),
            (e.prototype.setInt16 = n(h.Int16Array)),
            (e.prototype.setUint32 = n(h.Uint32Array)),
            (e.prototype.setInt32 = n(h.Int32Array)),
            (e.prototype.setFloat32 = n(h.Float32Array)),
            (e.prototype.setFloat64 = n(h.Float64Array)),
            (h.DataView = h.DataView || e);
        })();
    },
    function (t, e, r) {
      var n = r(79),
      ...
      t.exports = function (t) {
        return (
          t.body && t.body.getReader
            ? (t.readable = function () {
                return Promise.resolve(new i(t.body.getReader()));
              })
            : (t.readable = function () {
                return t.body && t.body.readable
                  ? Promise.resolve(t.body)
                  : t.bodyUsed
                    ? Promise.reject(new Error("body already in use"))
        ...
        function e(t) {
          ...
          n.call(this),
            (this._read = function () {
              t.read()
                .then(function (t) {
                  t.done ? e.push(null) : e.push(new r(t.value));
                })
                .catch(function (t) {
                  e.emit("error", t);
                });
    ...
    function (t, e, r) {
      ...
      t.exports = function (t) {
        if (!t || (!t.token && !t.access_token))
          throw new Error(
            "Watson SpeechToText: missing required auth parameter: options.token (CF) or options.access_token (RC)",
          );
        var e = t.url || "https://stream.watsonplatform.net/speech-to-text/api";
        return (
          (e = t.access_token
            ? e + "/v1/models?access_token=" + t.access_token
            : e + "/v1/models?access_token=" + t.token),
          fetch(e, {
            credentials: "omit",
    ...
    function (t, e, r) {
      "use strict";
      (e.synthesize = r(83)), (e.getVoices = r(84));
    },
    function (t, e, r) {
      "use strict";
      var n = r(31),
      ...
      t.exports = function (t) {
        if (!t || (!t.token && !t.access_token))
          throw new Error(
            "Watson TextToSpeech: missing required parameter: options.token (CF) or options.access_token (RC)",
          );
        (t["watson-token"] = t.token), delete t.token;
        var e = t.url || "https://stream.watsonplatform.net/text-to-speech/api",
          r = t.element || new Audio();
        return (
          (r.crossOrigin = "anonymous"),
          (r.src = e + "/v1/synthesize?" + i.stringify(n(t, o))),
          !1 !== t.autoPlay && r.play(),
          r
        );
      };
    ...
    function (t, e, r) {
      ...
      t.exports = function (t) {
        if (!t || (!t.token && !t.access_token))
          throw new Error(
            "Watson TextToSpeech: missing required auth parameter: options.token (CF) or options.access_token (RC)",
          );
        var e = t.url || "https://stream.watsonplatform.net/text-to-speech/api";
        return (
          (e = t.access_token
            ? e + "/v1/voices?watson-token=" + t.access_token
            : e + "/v1/voices?watson-token=" + t.token),
          fetch(e, {
            credentials: "omit",
            headers: { accept: "application/json" },
          })
