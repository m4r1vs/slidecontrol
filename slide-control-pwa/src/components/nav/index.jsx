      ...
      if (state) {
        if (bezier === "in") {
          drawer.style.transition =
            "margin-left .225s cubic-bezier(0.0, 0.0, 0.2, 1), opacity .225s cubic-bezier(1,0,1,0)";
        } else if (bezier === "out") {
          drawer.style.transition =
            "margin-left .195s cubic-bezier(0.4, 0.0, 0.6, 1), opacity .195s cubic-bezier(1,0,1,0)";
        }
              ...
              >
                <div>
                  <span>
                    ...
                    {lang.pages.extension}
                  </span>
                </div>
              </a>
            </div>

            <span class={style.credits}>
              {lang.pages.copyright[0]}
              {new Date().getFullYear()}
              <br />
              {lang.pages.copyright[1]}
            </span>
          </div>
        </nav>
        <div
          class={style.drawerBack}
          onClick={this.closeDrawer}
          id="drawerback"
        />
      </div>
