	...
	render() {
		return (
			<div class={style.aboutList} fadeIn>
				...
				<a href={this.state.serverURL} rel="noopener noreferrer" target="_blank">
					slidecontrol server<br />
					<span>Version {this.state.serverVersion}{this.state.serverHash}</span>
				</a>
