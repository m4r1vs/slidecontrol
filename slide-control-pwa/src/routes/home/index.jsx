...
export default class Home extends Component {
  ...
  render() {
    return (
      <div class={style.home} data-fade-in="true">
        <h1>{this.getGreeting()}</h1>

        <p>
          {lang.page.enterCode[0]}
          <br />
          {lang.page.enterCode[1]}
          <Link href="/help/">{lang.page.enterCode[2]}</Link>
          <br />
        </p>
        ...
        <form onSubmit={this.sendCode} autocomplete="off">
          ...
          <input
            class={style.button}
            type="submit"
            value={lang.page.submitCodeButton}
          />
