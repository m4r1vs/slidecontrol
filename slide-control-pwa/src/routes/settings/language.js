const languages = {
	en: {
		page: {
			...
			language: {
				title: 'Language',
				description: 'Slidecontrol is available in different languages, choose yours here. If you want to add a language or just help to translate slidecontrol, raise a GitHub issue please.',
				languages: {
					en: 'English',
					de: 'German'
				}
	...
	de: {
		page: {
			server: {
				...
				input: {
					title: 'Oder verbinde dich mit einem lokal von dir betriebenen slidecontrol server ("ws(s)://" nicht vergessen!):'
				},
				buttonSave: 'speichern'
			},
			language: {
				title: 'Sprache',
				description: 'Slidecontrol ist mehrsprachig. Wähle hier deine Sprache aus. Solltest du uns helfen wollen slidecontrol zu übersetzen, biete dies gerne auf GitHub an!',
				languages: {
					en: 'Englisch',
					de: 'Deutsch'
				}
